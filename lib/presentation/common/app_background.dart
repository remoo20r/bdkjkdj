      ...
      children: [
        ...
        const Positioned.fill(
          child: RepaintBoundary(
            child: CustomPaint(painter: _StreaksPainter()),
          ),
        ),
        const DecoratedBox(
...
class _StreaksPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final streaks = <_Streak>[
      _Streak(0.02, 6, const Color(0xFFFF2D55), 0.9),
      _Streak(0.10, 3, const Color(0xFFFF5A6A), 0.5),
      _Streak(0.18, 10, const Color(0xFFB01E5A), 0.7),
      _Streak(0.30, 4, const Color(0xFF8A2BE2), 0.5),
      _Streak(0.42, 7, const Color(0xFFE01E4B), 0.75),
      _Streak(0.55, 3, const Color(0xFFFF7A8A), 0.4),
      _Streak(0.66, 9, const Color(0xFF7A1FA2), 0.6),
      _Streak(0.78, 5, const Color(0xFFFF2D55), 0.7),
      _Streak(0.88, 3, const Color(0xFFC03AD6), 0.45),
      _Streak(0.96, 7, const Color(0xFFE01E4B), 0.6),
    ];
    ...
    for (final s in streaks) {
      ...
      final paint = Paint()
        ...
        ..maskFilter = MaskFilter.blur(BlurStyle.normal, s.width * 0.9);
