                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        _HomeTile(
                          ...
                          gradientColors: const [Color(0xFFF2D272), AppColors.redDark],
...
class _HomeTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final radius = (width * 0.16).clamp(18.0, 30.0);
    final iconCircle = (width * 0.46).clamp(46.0, 108.0);
    final iconSize = (iconCircle * 0.52).clamp(26.0, 60.0);
    final fontSize = (width * 0.12).clamp(15.0, 23.0);
      ...
      child: TvFocusable(
        ...
        child: Container(
          decoration: BoxDecoration(
            ...
            boxShadow: [
              // Colored outer glow — the premium "lit from within" look.
              BoxShadow(
          ...
          child: Stack(
            children: [
              ...
              // Content: icon in a frosted circle + label underneath.
              Padding(
